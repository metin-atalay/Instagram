...
import com.metinatalay.instagram.data.CommentData
import com.metinatalay.instagram.data.Event
import com.metinatalay.instagram.data.PostData
import com.metinatalay.instagram.data.UserData
...
class IgViewModel @Inject constructor(
    ...
    private fun updatePostUserImageData(imageUrl: String) {
        ...
        db.collection(POSTS).whereEqualTo("userId", currentuUid).get().addOnSuccessListener {
    ...
    fun createComment(postId: String, text: String) {
        userData.value?.username?.let { username ->
            ...
            db.collection(COMMENTS).document(commentId).set(comment).addOnSuccessListener {
                    getComments(postId)
                }.addOnFailureListener { exc ->
